...
/* Red-black tree implementation with recursion,
 * closely following the wiki page, but with no deletion. 
 * I might add it one day, but right now it is not essential. */
